...
if(isset($_POST['back']))
	...
	color:white;'> ------Заблокирован на 5 минут!------</h1> ";
...
<body>
	...
	<form  method="post" name="logfrm">
        <span class="logintextfield">
           <input type="text" id="username" placeholder="Логин" name="name" type="username"/>
	   </span>
       <input type="password" id="password" placeholder="Пароль" name="password" type="password"/>
       <span class="submitlog">
		 <input type="submit" name="login" value="Войти" onclick="return val()"/> </span> 
       <span class="submitlog"><input type="submit" value="Регистрация" name="signup"/> </span>
	</form>
    <script>
	function val()
		{
